  ...
  const scored = records
    .map((record) => {
      const haystack = [
        ...
        record.summary_en,
        record.summary_cn,
        record.scope_en?.join(" "),
        record.scope_cn?.join(" "),
        record.exclusions_en?.join(" "),
        record.exclusions_cn?.join(" "),
        record.engineering_use_en?.join(" "),
        record.engineering_use_cn?.join(" "),
        record.expert_note_en,
        record.expert_note_cn,
        record.impact_note,
        record.topics?.join(" "),
